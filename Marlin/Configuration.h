...
#define CUSTOM_MACHINE_NAME "Simmons 3D Printer"
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 100  // 100 default AnyCubic Firmware, try 160 and 200 (default Marlin)
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS DELTA_PRINTABLE_RADIUS - 10 // mm
  #endif
  ...
  #define DELTA_HEIGHT 333.9 // get this value from auto calibrate  /default 333.9 default 300)
  ...
  //mm  Get this value from auto calibrate
